    ...
    RecEquation(String str){
        ...
        if(str.charAt(0) == '3'){
            ...
            if(str.charAt(str.length() - 1) == ' '){
                this.eq = recalgebraboleana.substring(str, 8, str.length() - 1);
            }else{
                this.eq = recalgebraboleana.substring(str, 8, str.length());
            }
        }else{
            if(str.charAt(str.length() - 1) == ' '){
                this.eq = recalgebraboleana.substring(str, 6, str.length() - 1);
            }else{
                this.eq = recalgebraboleana.substring(str, 6, str.length());
            }            
        }
        ...
        if(this.eq.length() > 1){
            if(this.eq.length() > 1 && i >= this.eq.length() - 1){
                ...
                if(isSimple(i + 4)){
                    ...
                    this.eq = recalgebraboleana.substring(this.eq, 0, i) + resp + recalgebraboleana.substring(this.eq, j + 1, this.eq.length());
...
public class recalgebraboleana{
